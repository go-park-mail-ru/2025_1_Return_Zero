...
//
//	mockgen -source=internal/pkg/user/repository.go -destination=internal/pkg/user/mocks/mock_repository.go
//
...
// СhangePassword mocks base method.
func (m *MockRepository) СhangePassword(ctx context.Context, password string, id int64, newPassword string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "СhangePassword", ctx, password, id, newPassword)
	ret0, _ := ret[0].(error)
	return ret0
}

// СhangePassword indicates an expected call of СhangePassword.
func (mr *MockRepositoryMockRecorder) СhangePassword(ctx, password, id, newPassword any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "СhangePassword", reflect.TypeOf((*MockRepository)(nil).СhangePassword), ctx, password, id, newPassword)
}
