...
const file_album_album_proto_rawDesc = "" +
	"\n" +
	"\x11album/album.proto\x12\x05album\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bgoogle/protobuf/empty.proto\"1\n" +
	"\rAlbumIDAndURL\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x10\n" +
	"\x03url\x18\x02 \x01(\tR\x03url\"Y\n" +
	"\x12FiltersWithLabelID\x12(\n" +
	"\afilters\x18\x01 \x01(\v2\x0e.album.FiltersR\afilters\x12\x19\n" +
	"\blabel_id\x18\x02 \x01(\x03R\alabelId\"\x81\x01\n" +
	"\x12CreateAlbumRequest\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12$\n" +
	"\x04type\x18\x02 \x01(\x0e2\x10.album.AlbumTypeR\x04type\x12\x14\n" +
	"\x05image\x18\x03 \x01(\fR\x05image\x12\x19\n" +
	"\blabel_id\x18\x04 \x01(\x03R\alabelId\"E\n" +
	"\x05Query\x12\x14\n" +
	"\x05query\x18\x01 \x01(\tR\x05query\x12&\n" +
	"\auser_id\x18\x02 \x01(\v2\r.album.UserIDR\x06userId\"\x18\n" +
	"\x06UserID\x12\x0e\n" +
	...
	"\x14AlbumTypeCompilation\x10\x032\xe4\x05\n" +
	"\fAlbumService\x12:\n" +
	...
	"\x11GetFavoriteAlbums\x12\x18.album.FiltersWithUserID\x1a\x10.album.AlbumList\x12.\n" +
	"\fSearchAlbums\x12\f.album.Query\x1a\x10.album.AlbumList\x12>\n" +
	"\vCreateAlbum\x12\x19.album.CreateAlbumRequest\x1a\x14.album.AlbumIDAndURL\x125\n" +
	"\vDeleteAlbum\x12\x0e.album.AlbumID\x1a\x16.google.protobuf.Empty\x12?\n" +
	"\x10GetAlbumsLabelID\x12\x19.album.FiltersWithLabelID\x1a\x10.album.AlbumListB\tZ\a./albumb\x06proto3"
