...
var file_track_track_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x73, 0x52, 0x07, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x32, 0x90, 0x08, 0x0a,
	...
	0x09, 0x5a, 0x07, 0x2e, 0x2f, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_track_track_proto_depIdxs = []int32{
	...
	9,  // 46: track.TrackService.GetAllTracks:output_type -> track.TrackList
	22, // 47: track.TrackService.GetTrackByID:output_type -> track.TrackDetailed
	16, // 48: track.TrackService.CreateStream:output_type -> track.StreamID
	27, // 49: track.TrackService.UpdateStreamDuration:output_type -> google.protobuf.Empty
	9,  // 50: track.TrackService.GetLastListenedTracks:output_type -> track.TrackList
	9,  // 51: track.TrackService.GetTracksByIDs:output_type -> track.TrackList
	9,  // 52: track.TrackService.GetTracksByIDsFiltered:output_type -> track.TrackList
	4,  // 53: track.TrackService.GetAlbumIDByTrackID:output_type -> track.AlbumID
	9,  // 54: track.TrackService.GetTracksByAlbumID:output_type -> track.TrackList
	6,  // 55: track.TrackService.GetMinutesListenedByUserID:output_type -> track.MinutesListened
	7,  // 56: track.TrackService.GetTracksListenedByUserID:output_type -> track.TracksListened
	27, // 57: track.TrackService.LikeTrack:output_type -> google.protobuf.Empty
	9,  // 58: track.TrackService.SearchTracks:output_type -> track.TrackList
	9,  // 59: track.TrackService.GetFavoriteTracks:output_type -> track.TrackList
	0,  // 60: track.TrackService.AddTracksToAlbum:output_type -> track.TrackIdsList
	27, // 61: track.TrackService.DeleteTracksByAlbumID:output_type -> google.protobuf.Empty
