...
func TestUpdatePlaylistWithThumbnail(t *testing.T) {
	...
	playlist, err := repo.UpdatePlaylist(ctx, request)
	assert.NoError(t, err)
	assert.NotNil(t, playlist)
	assert.Equal(t, int64(1), playlist.ID)
	assert.Equal(t, "Updated Playlist", playlist.Title)
	assert.Equal(t, "new_thumbnail.jpg", playlist.Thumbnail)
...
func TestUpdatePlaylistWithoutThumbnail(t *testing.T) {
	...
	assert.Equal(t, int64(1), playlist.ID)
	assert.Equal(t, "Updated Playlist", playlist.Title)
	assert.Equal(t, "existing_thumbnail.jpg", playlist.Thumbnail)
...
func TestUpdatePlaylistsPublisityByUserID(t *testing.T) {
	...
	err := repo.UpdatePlaylistsPublisityByUserID(ctx, request)
	assert.NoError(t, err)
